...
//public ResponseEntity<Object> signin(@RequestBody User userCredentials) {
//    String email = userCredentials.getuEmail();
//    String password = userCredentials.getuPassword();
//
//    Optional<User> userOp = userServ.signin(email, password);
...
//    String email = credentials.get("uEmail");
//    String password = credentials.get("uPassword");
//
//    Optional<User> userOp = userServ.signin(email, password);
//    if (userOp.isPresent()) {
//        User u = userOp.get();
...
//    }
//}
//public ResponseEntity<Object> signin(@RequestParam("uEmail") String email, @RequestParam("uPassword") String password) {
//    Optional<User> userOp = userServ.signin(email, password);
//    if(userOp.isPresent()) {
//    	User u= userOp.get();
//    	return new ResponseEntity<>("Login Successfully",HttpStatus.OK);
